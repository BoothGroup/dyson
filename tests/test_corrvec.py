"""Tests for :module:`~dyson.solvers.dynamic.corrvec`."""
...
def test_vs_exact_solver(
    ...
    """Test correction vector compared to the exact solver."""
    ...
    gf_exact = grid.evaluate_lehmann(exact.result.get_greens_function())

    # Solve the Hamiltonian with CorrectionVector
    corrvec = CorrectionVector(
